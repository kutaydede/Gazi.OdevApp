...
namespace Gazi.OdevApp {
    ...
    public partial class OkulDbDataSet : global::System.Data.DataSet {
        ...
        public partial class OgrenciDataTable : global::System.Data.TypedTableBase<OgrenciRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OgrenciRow AddOgrenciRow(string Ad, string Soyad, string Numara) {
        ...
        public partial class OgretmenDataTable : global::System.Data.TypedTableBase<OgretmenRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OgretmenRow AddOgretmenRow(string Tc, string Ad, string Soyad) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OgretmenRow FindByTc(string Tc) {
...
namespace Gazi.OdevApp.OkulDbDataSetTableAdapters {
    ...
    public partial class OgrenciTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Ogrenci] ([Ad], [Soyad], [Numara]) VALUES (@Ad, @Soyad, @Numar" +
                "a)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Gazi.OdevApp.Properties.Settings.Default.OkulDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Ad, Soyad, Numara FROM dbo.Ogrenci";
        ...
        public virtual int Fill(OkulDbDataSet.OgrenciDataTable dataTable) {
        ...
        public virtual OkulDbDataSet.OgrenciDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            OkulDbDataSet.OgrenciDataTable dataTable = new OkulDbDataSet.OgrenciDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OkulDbDataSet.OgrenciDataTable dataTable) {
    ...
    public partial class OgretmenTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Ogretmen] WHERE (([Tc] = @Original_Tc) AND ([Ad] = @Original_A" +
                "d) AND ([Soyad] = @Original_Soyad))";
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Ogretmen] ([Tc], [Ad], [Soyad]) VALUES (@Tc, @Ad, @Soyad);\r\nSE" +
                "LECT Tc, Ad, Soyad FROM Ogretmen WHERE (Tc = @Tc)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Ogretmen] SET [Tc] = @Tc, [Ad] = @Ad, [Soyad] = @Soyad WHERE (([Tc]" +
                " = @Original_Tc) AND ([Ad] = @Original_Ad) AND ([Soyad] = @Original_Soyad));\r\nSE" +
                "LECT Tc, Ad, Soyad FROM Ogretmen WHERE (Tc = @Tc)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Tc, Ad, Soyad FROM dbo.Ogretmen";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(OkulDbDataSet.OgretmenDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual OkulDbDataSet.OgretmenDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            OkulDbDataSet.OgretmenDataTable dataTable = new OkulDbDataSet.OgretmenDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OkulDbDataSet.OgretmenDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
